...
import com.oj.ojBackend.model.dto.user.UserAddRequest;
import com.oj.ojBackend.model.dto.user.UserLoginRequest;
import com.oj.ojBackend.model.dto.user.UserQueryRequest;
import com.oj.ojBackend.model.dto.user.UserRegisterRequest;
import com.oj.ojBackend.model.dto.user.UserUpdateMyRequest;
import com.oj.ojBackend.model.dto.user.UserUpdateRequest;
...
public class UserController {
    ...
    /**
     * get user info based on id(admin only)
     *
     * @param id
     * @param request
     * @return
    ...
    /**
     * get masked user data by user id
     *
     * @param id
     * @param request
     * @return
    ...
    /**
     * get user info in page(admin only)
     *
